...
export async function onRequest(context) {
  ...
  const categoryQuery = isAuthenticated
    ? 'SELECT id, catelog, sort_order, parent_id, is_private, allow_bookmarks FROM category ORDER BY sort_order ASC, id ASC'
    : 'SELECT id, catelog, sort_order, parent_id, allow_bookmarks FROM category WHERE is_private = 0 ORDER BY sort_order ASC, id ASC';
